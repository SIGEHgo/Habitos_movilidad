    ...
    datasets: [
      {
        ...
        data: matriz_trabajoH[0],
      },
      {
        label: "Prioridad 2",
        backgroundColor: "rgba(98, 17, 50, 1)",
        data: matriz_trabajoH[1],
      },
      {
        label: "Prioridad 3",
        backgroundColor: "rgba(179, 142, 93, 1)",
        data: matriz_trabajoH[2],
      },
      {
        label: "Prioridad 4",
        backgroundColor: "#c4c4c4",
        data: matriz_trabajoH[3],
      },
      {
        label: "Prioridad 5",
        backgroundColor: "#ebc7d0",
        data: matriz_trabajoH[4],
      },
      {
        label: "Prioridad 6",
        backgroundColor: "#a01f41",
        data: matriz_trabajoH[5],
      },
      {
        label: "Prioridad 7",
        backgroundColor: "#254d50",
        data: matriz_trabajoH[6],
      },
    ],
  },
  options: {
    ...
    plugins: {
      title: {
        display: true,
        text: "Alternativas de transporte para realizar el viaje al hogar",
        font: {
          size: 24,
          weight: 'bold'
        }
